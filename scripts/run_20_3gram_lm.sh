...
if $run_pcm || $run_pcm_memory || $run_pcm_power || $run_pcm_pcie; then
  ...
  if $run_pcm_pcie; then
    ...
    log_debug "Launching pcm-pcie (CSV=/local/data/results/id_20_3gram_lm_pcm_pcie.csv, log=/local/data/results/id_20_3gram_lm_pcm_pcie.log, profiler CPU=${PCM_CPU}, workload CPU=${WORKLOAD_CPU})"
    idle_wait
  ...
  if $run_pcm; then
    ...
    log_debug "Launching pcm (CSV=/local/data/results/id_20_3gram_lm_pcm.csv, log=/local/data/results/id_20_3gram_lm_pcm.log, profiler CPU=${PCM_CPU}, workload CPU=${WORKLOAD_CPU})"
    idle_wait
  ...
  if $run_pcm_memory; then
    ...
    log_debug "Launching pcm-memory (CSV=/local/data/results/id_20_3gram_lm_pcm_memory.csv, log=/local/data/results/id_20_3gram_lm_pcm_memory.log, profiler CPU=${PCM_CPU}, workload CPU=${WORKLOAD_CPU})"
    idle_wait
    unmount_resctrl_quiet
