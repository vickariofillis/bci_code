...
install_startup_packages git build-essential ppp pptp-linux cpuset cmake intel-cmt-cat msr-tools numactl
...
EXPECTED_USER="${BCI_NODE_OWNER_USER}"
EXPECTED_GROUP="${BCI_NODE_OWNER_GROUP}"
