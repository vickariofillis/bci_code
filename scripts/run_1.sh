...
if $run_pcm || $run_pcm_memory || $run_pcm_power || $run_pcm_pcie; then
  ...
  if $run_pcm_pcie; then
    ...
    log_debug "Launching pcm-pcie (CSV=/local/data/results/id_1_pcm_pcie.csv, log=/local/data/results/id_1_pcm_pcie.log, tool core=${PCM_CPU}, workload core=${WORKLOAD_CPU})"
    idle_wait
  ...
  if $run_pcm; then
    ...
    log_debug "Launching pcm (CSV=/local/data/results/id_1_pcm.csv, log=/local/data/results/id_1_pcm.log, tool core=${PCM_CPU}, workload core=${WORKLOAD_CPU})"
    idle_wait
  ...
  if $run_pcm_memory; then
    ...
    log_debug "Launching pcm-memory (CSV=/local/data/results/id_1_pcm_memory.csv, log=/local/data/results/id_1_pcm_memory.log, tool core=${PCM_CPU}, workload core=${WORKLOAD_CPU})"
    idle_wait
    unmount_resctrl_quiet
