...
# Perf stat
# Hardware Events
perf stat -e branch-instructions,branch-misses,cache-misses,cache-references,cpu-cycles,instructions,stalled-cycles-backend,stalled-cycles-frontend -x, -o /scratch/e/enright/vickario/research/bci/stats/id-13/perf_stat/$d/perf_stat_1_${SLURM_JOB_ID}.csv -- python motor.py
